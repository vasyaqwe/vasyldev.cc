...
const buttonVariants = cva(
   ...
   disabled:pointer-events-none disabled:opacity-80 border shadow-sm transition-all button hover:opacity-90`,
   {
      variants: {
         variant: {
            default: `bg-gradient-to-tr from-primary/90 font-medium to-primary/70 text-background border-primary`,
            outline: `bg-background hover:border-border border-border/70 hover:bg-border/10 `,
         },
         size: {
            default: "h-10 px-3",
            sm: "h-9 px-2",
